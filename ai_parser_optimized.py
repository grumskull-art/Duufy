...
_ALIASES: dict[str, str] = {
    ...
    'øllebørd': 'øllebrød', 'riberhus': 'ost', 'mellemlagret': 'ost',
}
...
_SPLIT_PATTERN = re.compile(r"\s+og\s+|\s*,\s*|\s+samt\s+|\s+plus\s+|\s+så\s+|\s+også\s+|\s+derefter\s+")
...
def _fuzzy_correct(word: str) -> str:
    ...
    brand_prefixes = ['arla', 'lurpak', 'kims', 'cocio', 'riberhus', 'knorr', 'fjordland', 'thise']
    words = lower.split()
